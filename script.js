...
const API_BASE = 'https://hsk1-platform.onrender.com/api';
...
fetch('https://hsk1-platform.onrender.com/api/words')
  .then(res => res.json())
  .then(data => {
...
if (signinForm) {
  signinForm.addEventListener('submit', async (e) => {
    ...
    try {
      const res = await fetch('https://hsk1-platform.onrender.com/api/auth/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email, password })
      });
...
if (signupForm) {
  signupForm.addEventListener('submit', async (e) => {
    ...
    try {
      const res = await fetch('https://hsk1-platform.onrender.com/api/auth/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ name, email, password })
      });
...
function saveProgressToBackend(progressValue) {
  ...
  fetch('https://hsk1-platform.onrender.com/api/auth/progress', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
function downloadCertificate() {
  ...
  window.open(`https://hsk1-platform.onrender.com/api/certificates/download/${user.id}`, '_blank');
}
...
function sendCertificateToEmail() {
  ...
  fetch(`https://hsk1-platform.onrender.com/api/certificates/send-email/${user.id}`)
    .then(res => res.json())
...
async function handleSendCode() {
  ...
  try {
    const res = await fetch('https://hsk1-platform.onrender.com/api/auth/send-code', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ name, email, password })
    });
...
document.getElementById('signupForm')?.addEventListener('submit', async function(e) {
  ...
  try {
    const res = await fetch('https://hsk1-platform.onrender.com/api/auth/verify-code', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
